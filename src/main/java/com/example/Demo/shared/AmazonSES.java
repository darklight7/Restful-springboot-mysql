...
public class AmazonSES {
    ...
    final String FROM = "sidd147258@gmail.com";

    // The subject line for the email.
    final String SUBJECT = "Hi Sharan ";

    final String PASSWORD_RESET_SUBJECT = "Password reset request";

    // The HTML body for the email.
    final String HTMLBODY = "<h1>HI Sharan </h1>"
            + "<p>Kaisa hai ,"
            + "aab to haam dono busy hai ;)   ....." + "</a><br/><br/>"
            + "thanks bhai for everthing ..." + "</a><br/><br/>"

            + "SHaam me dota khelte hai";

    // The email body for recipients with non-HTML email clients.
    final String TEXTBODY = "HI Sharan"
            + "<p>Kaisa hai ,"
            + "aab to haam dono busy hai ;)    ....." + "</a><br/><br/>"
            + "thanks bhai for everthing ..." + "</a><br/><br/>"
